...
import pic1 from "../assets/NIGERIAXBRAZILFOOTBALL SHORTS.png";
import pic2 from "../assets/170425_ASHLUXE14992.avif";
import pic3 from "../assets/cord 2.avif";
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">Nigeria X Brazil Football Shorts</p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <h1 className="text-4xl pb-3">Nigeria X Brazil Football Shorts</h1>
          <b className="text-2xl opacity-70">$187</b>

          {/* Color */}
          <p className="pt-5 opacity-40 pb-2">Colour</p>
          <div className="bg-green-700 w-7 h-7 rounded-full border-black border-2"></div>
...
export default NigXBrazilShort;
