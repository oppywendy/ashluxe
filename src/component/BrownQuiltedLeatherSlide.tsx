...
import pic1 from "../assets/slide2.avif";
...
const BrownQuiltedLeatherSlide = () => {
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">Ashluxe Paradise Quilted Leather Slides Brown</p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <h1 className="text-4xl pb-3">
            Ashluxe Paradise Quilted Leather Slides Brown
          </h1>
          <b className="text-2xl opacity-70">$259</b>

          {/* Color */}
          <p className="pt-5 opacity-40 pb-2">Colour</p>
          <div className="bg-orange-950 w-7 h-7 rounded-full border-black border-2"></div>
          <p className="pt-2 text-sm opacity-80">Brown</p>
...
export default BrownQuiltedLeatherSlide;
