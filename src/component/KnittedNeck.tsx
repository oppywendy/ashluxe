...
import pic1 from "../assets/knitted black 1.avif";
import pic2 from "../assets/knitted black 2.avif";
import pic3 from "../assets/knitted black 3.avif";
import pant from "../assets/pants 5.avif";
...
const KnittedNeck = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: 1,
      name: "Knitted Neck Rib Logo T-shirt Black",
      price: 156,
      quantity: count,
      image: display,
    };
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">Knitted Neck Rib Logo T-shirt Black</p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <h1 className="text-4xl pb-3">
            Ashluxe Knitted Neck Rib Logo T-shirt Black
          </h1>
          ...
          <div className="pt-5">
            ...
            <div className="flex flex-col sm:flex-row w-full justify-between pt-5 items-center sm:items-start gap-4">
              ...
              <img src={pant} alt="" className="w-28" />
              <div className="flex flex-col items-center">
                <h2 className="opacity-80">Ashluxe Denim Pant</h2>
                <select
                  value={value}
                  onChange={(e) => setValue(e.target.value)}
                  className="w-28 py-1 border border-gray-300 rounded-md text-sm text-center my-3"
                >
                  <option value="">Black / XS</option>
                  <option value="s">Black / S</option>
                  <option value="m">Black / M</option>
                  <option value="l">Black / L</option>
                </select>
