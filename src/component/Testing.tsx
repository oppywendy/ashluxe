...
import pic1 from "../assets/nigxbrayellow 1.avif";
...
const Testing = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: 1,
      name: "Nigeria X Brazil Football Shirt Yellow",
      price: 198,
      quantity: count,
      image: display,
    };
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">Nigeria X Brazil Football Shirt Yellow</p>
      </div>
        ...
        <div className="w-[40%] h-[70vh] flex justify-center items-center gap-5 px-10">
          ...
          <div className="h-[90%] w-[75%]">
            <img
              src={display}
              alt="Product"
              className="w-[60vh] h-full border border-black rounded-2xl bg-[#DDDDDD] object-cover"
            />
          </div>
        </div>

        {/* Right Info Section */}
        <div className="w-[50%] pt-5 pr-10">
          <p className="text-black opacity-75">Ashluxe</p>
          <h1 className="text-4xl pb-3">
            Nigeria X Brazil Football Shirt Yellow
          </h1>
          <b className="text-2xl opacity-70">$198</b>

          {/* Color */}
          <p className="pt-5 opacity-40 pb-2">Colour</p>
          <div className="bg-yellow-200 w-7 h-7 rounded-full border-black border-2"></div>
          <p className="pt-2 text-sm opacity-80">Yellow</p>
          ...
          <div className="pt-7 flex gap-5">
            <div className="relative">
              <input
                ...
                value={count}
                readOnly
                className="w-[15rem] h-[3rem] rounded-lg bg-[#FFFFFF] border border-black text-center"
              />
              <button
                onClick={increment}
            ...
            <button
              ...
              className="w-[20rem] h-[3rem] rounded-lg border text-white border-black bg-black hover:bg-gray-800 transition"
            >
              Add to cart
            </button>
          </div>
          ...
          <div className="pt-5">
            ...
            <div className="flex w-full justify-between pt-5">
              ...
              <div className="flex flex-col items-center">
                <h2 className="opacity-80">Nigeria X Brazil Football Shorts</h2>
                <select
                  value={value}
                ...
                <p className="font-medium">$184.00</p>
              </div>
            </div>
          </div>
        </div>
