...
import pic1 from "../assets/female t 1.avif";
import pic2 from "../assets/croptop.webp";
...
const AshluxeWomen = () => {
  ...
  const handleAddToCart = () => {
    const product = {
      id: 1,
      name: "Ashluxe Women A Bling Star Layered Crop Tee Black",
      price: 145,
      quantity: count,
      image: display,
    };
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">
          Ashluxe Women A Bling Star Layered Crop Tee Black
        </p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <b className="text-2xl opacity-70">$145</b>
