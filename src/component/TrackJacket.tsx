...
import pic1 from "../assets/femaletrackjacketpinkaop.avif";
import pic2 from "../assets/femaletrackjacketpinkaop2.webp";
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">
          Ashluxe Female Printed Track Jacket Pink Flower Aop
        </p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <div className="bg-pink-200 w-7 h-7 rounded-full border-black border-2"></div>
          <p className="pt-2 text-sm opacity-80">Pink Flower Aop</p>
