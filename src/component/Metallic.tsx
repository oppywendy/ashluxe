...
import pic1 from "../assets/hoodie 1.avif";
import pic2 from "../assets/METALLICSMALLLOGOSWEATSHIRT.avif";
import pic3 from "../assets/METALLICSMALLLOGOSWEATSHIRT3.avif";
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">Metallic Small Logo Sweatshirt</p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <h1 className="text-4xl pb-3">Metallic Small Logo Sweatshirt</h1>
