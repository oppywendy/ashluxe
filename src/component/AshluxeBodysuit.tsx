...
import pic1 from "../assets/bodysuitpink.avif";
import pic2 from "../assets/female t 8.avif";
import glass from "../assets/sunglass1.avif";
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">Ashluxe -A- Bodysuit Pink</p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <h1 className="text-4xl pb-3">Ashluxe -A- Bodysuit Pink</h1>
          <b className="text-2xl opacity-70">$83</b>

          {/* Color */}
          <p className="pt-5 opacity-40 pb-2">Colour</p>
          <div className="bg-pink-500 w-7 h-7 rounded-full border-black border-2"></div>
          <p className="pt-2 text-sm opacity-80">Pink</p>
          ...
          <div className="pt-5">
            ...
            <div className="flex flex-col sm:flex-row w-full justify-between pt-5 items-center sm:items-start gap-4">
              ...
              <img src={glass} alt="" className="w-28" />
              <div className="flex flex-col items-center">
                <h2 className="opacity-80">
                  Ashluxe Pixel Earth Sunglasses Brown
                </h2>
...
export default AshluxeBodysuit;
