...
import pic1 from "../assets/hoodie 5.avif";
import pic2 from "../assets/hoodiebold.avif";
  ...
  return (
    <div className="bg-[#F8F8F8]">
      ...
      <div className="flex pt-14 pb-5 pl-10 items-center gap-3">
        ...
        <p className="text-sm">Ashluxe Bold Logo Hoodie</p>
      </div>
      ...
      <div className="w-full lg:flex grid lg:flex-row justify-center items-center lg:items-start">
        ...
        <div className="w-full lg:w-[50%] pt-5 px-5 lg:pr-10">
          ...
          <h1 className="text-4xl pb-3">Ashluxe Bold Logo Hoodie</h1>
          <b className="text-2xl opacity-70">$280</b>
